...
@Component
@Scope("prototype")
public class StateProvider implements ValueProvider {

    private static final List<ValuePair<?>> BUFFER;

    static {
        BUFFER = Lists.newArrayList();
        BUFFER.addAll(Stream.of(CustomerEnum.State.values())
    ...
    public String getDisplayText(Object obj, Map metaMap, FieldMeta fieldMeta) {
        ...
        CustomerEnum.State instance = CustomerEnum.State.getInstance(Integer.valueOf(obj.toString()));
